...
//   m_bindings['k']    = sigc::mem_fun(this, &ElementText::entry_prev);
//   m_bindings['j']  = sigc::mem_fun(this, &ElementText::entry_next);
//   m_bindings['l'] = m_bindings['F' - '@'] = sigc::mem_fun(this, &ElementText::entry_select);
}
